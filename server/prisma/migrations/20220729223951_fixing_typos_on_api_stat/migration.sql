...
INSERT INTO "new_ApiStats" ("accountBirthday", "billingPeriodEnd", "billingPeriodStart", "numApiCallsAllowedInPeriod", "numApiCallsRemainingInBillingPeriod", "numApiCallsSinceAccountBirthday", "numApiCallsSinceBillingStart", "userId") SELECT "accountBirthday", "billingPeriodEnd", "billingPeriodStart", "numApiCallsAllowedInPeriod", "numApiCallsRemainingInBillingPeriod", "numApiCallsSinceAccountBirthday", "numApiCallsSinceBillingStart", "userId" FROM "ApiStats";
DROP TABLE "ApiStats";
